...
Run with: dsm [-c N]  (or: python -m vae)
"""
...
from vae.config import RedisConfig, config
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    worker_argv = [sys.executable, "-m", "vae.worker"]
    if args.concurrency:
    ...
    try:
        ...
        children.append(subprocess.Popen([sys.executable, "-m", "vae.api"]))
