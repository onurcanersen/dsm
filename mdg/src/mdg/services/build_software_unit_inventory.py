...
candidate versions applied (SRS DSM-MDG req 10-11)."""
...
class BuildSoftwareUnitInventory:
    ...
    replacing or adding each candidate unit at its candidate version (req 11)."""

    def __init__(self, config_repo: IConfigManagementRepository):
        self._config_repo = config_repo

    def execute(
        self, context: ProjectContext, candidates: Sequence[CandidateUnitVersion] = ()
        ...
        return inventory.with_candidates(candidates)
