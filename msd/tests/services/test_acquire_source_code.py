...
repository failures (SRS DSM-MSD req 13-16)."""

from pathlib import Path

from fakes import seed
from fakes.fake_source_code_repository import FakeSourceCodeRepository
from msd.domain.error_record import ErrorStatus
from msd.domain.inventory import SoftwareUnitVersion
from msd.domain.model_setup_data import UnitStatus
from msd.ports.source_code_repository import SourceRepoAuthError
