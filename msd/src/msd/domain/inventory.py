"""The Software Unit Version Inventory and the candidate version under
evaluation (SRS DSM-MSD req 10-11)."""
...
class SoftwareUnitVersion:
    """One software unit at one version (req 10), flagged when it is the
...
class CandidateUnitVersion:
    """The version of a software unit being evaluated for installation into
