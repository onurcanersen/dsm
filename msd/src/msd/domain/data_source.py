"""The external data sources DSM-MSD reads and their user-definable connection
information (SRS DSM-MSD req 2, 4)."""
...
class SourceType(Enum):
    """The data source categories DSM-MSD accesses (req 2)."""
