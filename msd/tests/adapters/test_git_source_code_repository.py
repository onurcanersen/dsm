...
acquired file records and version listing (SRS DSM-MSD req 11, 13-16)."""
...
from msd.ports.source_code_repository import SourceRepoAccessError, SourceRepoAuthError, SourceRepoIntegrityError
...
def _fake_git(monkeypatch, stdout="", returncode=0, stderr="", captured=None):
    ...
    monkeypatch.setattr("msd.adapters.source_code.git_source_code_repository.subprocess.run", run)
